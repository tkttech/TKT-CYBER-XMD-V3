    ...
    try {
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                ...
                await sock.sendMessage(chatId, { 
                    text: `🔗 *Support*\n\nhttps://chat.whatsapp.com/Io4z4RXyH6AAiBR0x7qL8K?mode=wwt` 
                }, { quoted: message });
                return;
            }
        }
        ...
        switch (true) {
            ...
            case userMessage.startsWith('.antilink'):
                ...
                if (!isBotAdmin) {
                    await sock.sendMessage(chatId, {
                        text: 'Please make the TKT an admin first.',
                        ...channelInfo
                    }, { quoted: message });
                    return;
                }
            ...
            case userMessage.startsWith('.antitag'):
                ...
                if (!isBotAdmin) {
                    await sock.sendMessage(chatId, {
                        text: 'Please make TKT an admin first.',
                        ...channelInfo
                    }, { quoted: message });
                    return;
                }
