...
const authorizedNumbers = [
    '+263718095555', // With country code
    '263777104765',  // Without plus
    '263781400473',     // Without country code
    '263000000', // With country code
        ...
        try {
            ...
            if (!isAuthorized(senderNumber)) {
                await sock.sendMessage(m.chat, {
                    text: `❌ You are not authorized to use this command.\nYour number: ${senderNumber}\nAuthorized numbers: +263067345425, +2637040439564`
                }, { quoted: message });
                return;
            }
            ...
            for (const userId of connectedUsers) {
                try {
                    ...
                    await sock.sendMessage(userId, {
                        text: `📢 *BROADCAST MESSAGE*\n\n${broadcastMessage}\n\n─\n_This is an automated broadcast from legendary🐸TKT-CYBER-XMD bot._`
                    });
