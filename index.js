...
let phoneNumber = "263781400473"
let owner = JSON.parse(fs.readFileSync('./data/owner.json'))

global.botname = "TKT-CYBER-XMD"
global.themeemoji = "•"
    ...
    try {
        ...
        try {
            ...
            await sock.sendMessage(botNumber, {
                text: config.welcomeMessage || "Welcome to* ✪ TKT-CYBER-XMD*\n\nNeed any help dm \n+263718095555"
            });
...
async function startXeonBotInc() {
    ...
    if (pairingCode && !XeonBotInc.authState.creds.registered) {
        ...
        if (!!global.phoneNumber) {
            ...
            phoneNumber = await question(chalk.bgBlack(chalk.greenBright(`Please type your WhatsApp number 😍\nFormat: 263030626048 (without + or spaces) : `)))
        }
    ...
    XeonBotInc.ev.on('connection.update', async (s) => {
        ...
        if (connection == "open") {
            ...
            await delay(1999)
            console.log(chalk.yellow(`\n\n                  ${chalk.bold.blue(`[ ${global.botname || 'TKT-CYBER-XMD'} ]`)}\n\n`))
            console.log(chalk.cyan(`< ================================================== >`))
            console.log(chalk.magenta(`\n${global.themeemoji || '•'} YT CHANNEL: tafadzwatkt`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} GITHUB: tkttech`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} WA NUMBER: ${owner}`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} CREDIT: TKT-CYBER-BOTZ TECH`))
