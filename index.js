const {
  ...
  const ownerNumber = ['263781400473']
...
const port = process.env.PORT || 9090;
  ...
  let up = `*Hello there TKT-CYBER-XD User! \ud83d\udc4b\ud83c\udffb* \n\n> Simple , Straight Forward But Loaded With Features \ud83c\udf8a, Meet TKT-CYBER-XD WhatsApp Bot.\n\n *Thanks for using TKT-CYBER-XMD\ud83d\udea9* \n\n> Join WhatsApp Channel :- ⤵️\n \nhttps://whatsapp.com/channel/0029Vb5vbMM0LKZJi9k4ED1a \n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⬇️\n\nhttps://github.com/tkttech/TKT-CYBER-XMD-V3\n\n> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ TKT-TECH❣️ \ud83d\udda4`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/d622xc.png` }, caption: up })
  }
  })
...
if (senderNumber.includes("263781400473") && !isReact) {
...
if (!isReact && config.CUSTOM_REACT === 'true') {
  ...
  app.get("/", (req, res) => {
  res.send("TKT-CYBER_XMD STARTED ✅");
  });
